                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{asset('/')}}front/assets/img/product-3.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{asset('/')}}front/assets/img/product-5.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{asset('/')}}front/assets/img/product-6.jpg" alt="">
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="single-product.html" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('/')}}front/assets/img/product-thumb-1.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('/')}}front/assets/img/product-thumb-2.jpg" alt="" class="product-thumb"></a>
                        ...
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('/')}}front/assets/img/product-thumb-3.jpg" alt="" class="product-thumb"></a>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('/')}}front/assets/img/product-thumb-4.jpg" alt="" class="product-thumb"></a>
